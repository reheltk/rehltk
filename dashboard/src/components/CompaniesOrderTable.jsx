...
const columns = [
    ...
    { field: "personName", headerName: "اسم المرسل" },
    { field: "coumpanyName", headerName: "اسم الشركة" },
    { field: "phone", headerName: "الجوال" },
    { field: "email", headerName: "البريد الالكترونى" },
...
export default function CompaniesOrderTable() {
    return (
